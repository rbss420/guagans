...
conn.on('message-status-update', json =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @kingg_squard028`)
})
...
conn.sendMessage(id, 'https://chat.whatsapp.com/DswgumiH36fJkuIrEO25KT' ,MessageType.text, { quoted: m });
}
  ...
  var teks = text.replace(/!tts /, '')
    ...
    .then((res) => {
      audioToBase64(res.data.result)
        .then(
          (ress) => {
            conn.sendMessage(id, '[WAIT] Prosess...❗', MessageType.text, { quoted: m })
            var buf = Buffer.from(ress, 'base64')
...
if (text.includes('!fotoanime2')){
  var teks = text.replace(/!fotoanime2 /, '')
...
if (text.includes("!infonomor")){
const teks = text.replace(/!infonomor/, "")
...
conn.sendMessage(id, '*Tunggu sebentar ya sayang...*', MessageType.text, { quoted: m })
}
else if (text == '!menu'){
conn.sendMessage(id, 'Command Salah, Untuk Command Ketik !help Yaa', MessageType.text, { quoted: m })
}
else if (text == '#menu'){
conn.sendMessage(id, 'Command Salah, Untuk Command Ketik !help Yaa', MessageType.text, { quoted: m })
}
...
conn.sendMessage(id, 'Lu Bacod -BOT', MessageType.text, { quoted: m })
}
else if (text == '.menu'){
conn.sendMessage(id, 'Command Salah, Untuk Command Ketik !help Yaa', MessageType.text, { quoted: m })
}
...
conn.sendMessage(id, 'Mmk Lu Bau Njim -BOT', MessageType.text, { quoted: m })
}
else if (text == 'memek'){
conn.sendMessage(id, 'Mmk Lu Bau Njim -BOT', MessageType.text, { quoted: m })
}
else if (text == 'Kontol'){
conn.sendMessage(id, 'Kntl Lu Bau Njim -BOT', MessageType.text, { quoted: m })
}
else if (text == 'Pagi'){
...
conn.sendMessage(id, 'iya aku Ganteng Kan', MessageType.text, { quoted: m })
}
...
if (text.includes('!pornlogo')){
  var teks = text.replace(/!pornlogo /, '')
